return {
	...
	DESCRIBE =
	{
		...
		MEATRACK =
		{
			...
			DRYING_NOTMEAT = "WETNESS IS TRULY THE WORSE",
        ...
        ROCK_AVOCADO_FRUIT_RIPE_COOKED = "MY WEAK MINIONS DESIRE MUSHINESS FOR THEIR FLESH STOMACHES",
        ...
        SEAFARER_KIT = "WRETCHED MATERIALS FOR BUILDING A WRETCHED BOAT",
